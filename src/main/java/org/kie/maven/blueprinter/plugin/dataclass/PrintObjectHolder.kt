...
/**
 * Utility class to store objects used throughout execution for [PrintMojo] purpose
 ...
 *
 */
data class PrintObjectHolder(
    val globalRelationshipSet: HashSet<Relationship>,
